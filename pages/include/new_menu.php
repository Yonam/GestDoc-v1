...
<?php 
    ...
    $domas=$reqt->fetch();
    $final = 0;
    $arret = '<a disabled class="btn btn-danger fa fa-close" href="pages/administration/Journee/script_arret_jrnee.php?id='.$final.'&identif='.$user.'"> Arrêt de caisse </a>';
    if ($domas == false) {
        echo "<div class=\"alert alert-danger alert-dismissable\">
        <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>
        <h4> Attention il n'y a plus aucune journee de vente active . </h4> 
        </div>";
    }else{
        if ($domas->CODE_JOURNEE != 0) {
            $final=$domas->CODE_JOURNEE;
            $arret = '<a class="btn btn-danger fa fa-close" href="pages/administration/Journee/script_arret_jrnee.php?id='.$final.'&identif='.$user.'"> Arrêt de caisse </a>';
        }
...
$menu =  '<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="?page="> GestiDoc | Interface ' . $_SESSION['Auth']->designation. ' </a>
            </div>
            <ul class="nav navbar-top-links navbar-right">';

if ($_SESSION['Auth']->level == 5 || $_SESSION['Auth']->level == 4 || $_SESSION['Auth']->level == 3|| $_SESSION['Auth']->level == 2|| $_SESSION['Auth']->level == 1){
echo $menu;}
?>
<!-- /.navbar-header -->
<?php
	 ...
	 /*<li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
            ...
            <ul class="dropdown-menu dropdown-user">
                ...
                <li><a href="?page=recap_journee"> <i class="fa fa-calendar-plus-o fa-fw"></i> Recap Journée</a>
            ...
            <!-- /.dropdown-user -->
                ...
                if ($_SESSION['Auth']->level == 5 || $_SESSION['Auth']->level == 3|| $_SESSION['Auth']->level == 2|| $_SESSION['Auth']->level == 1){
                    echo $menu;}
                ?>
                <!-- /.dropdown-user -->
                <?php
			 ...
			 <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-gear fa-list"></i> GESTION  <i class="fa fa-caret-down"></i>
                    </a>
