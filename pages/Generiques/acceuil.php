...
$sqlNbVenteJour = 'select count(*) as nbVenteJour from vente where code_journee = (select code_journee from journee where statut = 0) and code_encaissement is not null';
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $NbFourn['nbFourn'] ; ?></div>
                                    <div>Fournisseurs</div>
                                </div>
                            </div>
                        </div>
                        <a href="?page=liste_fournisseur">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $NbCom['nbCom'] ; ?></div>
                                    <div>Commercials</div>
                                </div>
                            </div>
                        </div>
                        <a href="?page=liste_commercial">
                            <div class="panel-footer">
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
