 ...
 .sign.error-page-wrapper .buttons-container a:hover .fa-home {
  ...
  @media screen and (max-width: 500px) {
   ...
   .sign.error-page-wrapper .buttons-container .fa {
    ...
    .background-color {
      background-color: rgba(141, 205, 227, 1) !important;
    }
    ...
    .sign-text-color {
      color: rgba(118, 209, 240, 1) !important;
    }

    .sign-frame-color {
      color: rgba(115, 119, 120, 1);
    }
    ...
    .border-button {
      color: rgba(234, 241, 242, 1) !important;
      border-color: rgba(234, 241, 242, 1) !important;
    }
    .button {
      background-color: rgba(234, 241, 242, 1) !important;
      color:  !important;
    }
  ...
  <div class="sign error-page-wrapper background-color background-image">
	...
	<div class="pane">
		...
		<div class="context sign-text-color">
			Oops,<br> Vous avez oublie quelque chose!<br>
			Vous devez d'abord ouvrir une journee :D.
		</div>
	</div>
</div>
